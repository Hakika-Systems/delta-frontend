...
<div class="surface-section px-4 py-8 md:px-6 lg:px-8">
  ...
  <div class="grid grid-nogutter align-items-center">
    ...
    <div class="p-button bonmarche p-togglebutton p-component p-highlight mb-3 lg:mt-0 mr-4 flex-shrink-0 w-12rem" data-pc-name="togglebutton" data-pc-section="root" data-p-active="true" data-pd-ripple="true">
    ...
    <div class="p-button bonmarche p-togglebutton p-component mb-3 lg:mt-0 mr-4 flex-shrink-0 w-9rem" data-pc-name="togglebutton" data-pc-section="root" data-p-active="false" data-pd-ripple="true">
      <span class="p-hidden-accessible" data-pc-section="hiddeninputwrapper" data-p-hidden-accessible="true">
